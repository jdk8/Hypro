...
#define LOG2_BLOCK_SIZE(data)	   (le32_to_uint32(&(data->sblock.log2_block_size)) + EXT2_MIN_BLOCK_LOG_SIZE)
#define INODE_SIZE_FILESYSTEM(data)	(le32_to_uint32(&(data->sblock.inode_size)))
